...
model = dict(
    ...
    bbox_head=dict(
        ...
        in_channels=2048, # embed_dims(256) * num_heads(8)과 같은 수
    ...
    test_cfg=dict(max_per_img=20))  # TODO 잠시 20->10 바꿈 / set 'max_per_img=20' for time counting
# optimizer
optimizer = dict(
    type='AdamW',
    lr=2e-4,
...
runner = dict(type='EpochBasedRunner', max_epochs=100) # TODO 잠시 1로 바꿈
